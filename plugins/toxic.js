let handler  = async (m, { conn }) => {
  m.reply(`${pickRandom(global.toxic)}`)
}
handler.help = ['toxic']
handler.tags = ['fun']
...
let kata = ['babi', 'monyet', 'anjing', 'bool', 'jembut', 'memek', 'kontol', 'tempik', 'ngentod', 'gay', 'lesbi', 'asep', 'setan', 'pepek', 'cangcut', 'bagong', 'bangsat', 'ngentot']
