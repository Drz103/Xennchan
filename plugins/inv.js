...
let handler = async (m, { conn, usedPrefix }) => {
    let { registered, age, lastrampok, lastberburu, lastbansos, lastadventure, lastfishing, lastduel, lastmining, lastclaim, lastweekly, lastmonthly } = global.db.data.users[m.sender]
...
╰────────────────\n\n
*Coldown*
Berburu : ${lastberburu > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Berburu*'}
Memancing : ${lastfishing > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Mancing*'}
Adventure : ${lastadventure > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Berpetualang*'}
Duel : ${lastduel > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap By one*'}
Rampok : ${lastrampok > 0 ? '❌ *Sedang Coldown*'  : '✅ *Siap Rampok*'}
Mining : ${lastmining > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Mining*'}
Bansos : ${lastbansos > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Korupsi*'}
Claim : ${lastclaim > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Claim*'}
Weekly : ${lastweekly > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Weekly*'}
Monthly : ${lastmonthly > 0 ? '❌ *Sedang Coldown*' : '✅ *Siap Monthly*'}\n\n
*achievement*
...
🚫Banned: *No*
`.trim()
    conn.sendBut(m.chat, str, wm, 'SHOP', '.shop', m)
}
