...
let kolam = 'https://telegra.ph/file/5aa5dfa3394477e11fb18.jpg'
let past = `*《 ISI KOLAM 》*
...
*🐡Buntal = ${buntal}*
*🐳Orca = ${orca}*`.trim()
  await conn.send2ButtonLoc(m.chat, await(await fetch(kolam)).buffer(), past, wm, 'PASAR', '#pasar', 'SHOP', '#shop', m)
  }
